 ...
 * Uses the "persistence-unit" called "CloudSQL".
 */
    ...
    retrieveInventory(emf, em, tx);

    performQuery(emf, em, tx);

    removeData(emf, em, tx);
    }

    private static void removeData(EntityManagerFactory emf, EntityManager em, EntityTransaction tx) {
    ...
    private static void performQuery(EntityManagerFactory emf, EntityManager em, EntityTransaction tx) {
    ...
    private static void retrieveInventory(EntityManagerFactory emf, EntityManager em, EntityTransaction tx) {
    ...
    private static void createAdd(EntityManagerFactory emf, EntityManager em, EntityTransaction tx) {
    em = emf.createEntityManager();
    tx = em.getTransaction();
